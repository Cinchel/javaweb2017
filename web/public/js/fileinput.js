...
(function (factory) {
    ...
    $.fn.fileinputLocales.en = {
        fileSingle: 'file',
        filePlural: 'files',
        browseLabel: '选择文件',//'Browse &hellip;',
        removeLabel: '清除文件',//Remove',
        removeTitle: 'Clear selected files',
        cancelLabel: 'Cancel',
        cancelTitle: 'Abort ongoing upload',
        uploadLabel: '申请',//'Upload',
        ...
        msgInvalidFileExtension: '文件"{name}"不合法，只有"{extensions}"格式文件能被选择.',//'Invalid extension for file "{name}". Only "{extensions}" files are supported.',
        ...
        dropZoneTitle: '可拖拽文件至此',//'Drag & drop files here &hellip;',
